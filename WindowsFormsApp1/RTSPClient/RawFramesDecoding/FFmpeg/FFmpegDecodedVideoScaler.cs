...
namespace FPV.RawFramesDecoding.FFmpeg
{
    class FFmpegDecodedVideoScaler
    {
            ...
            TransformParameters transformParameters)
        {
            ...
            int resultCode = FFmpegVideoPInvoke.CreateVideoScaler(sourceLeft, sourceTop, sourceWidth, sourceHeight,
                (FFmpegPixelFormat)decodedVideoFrameParameters.PixelFormat,
        ...
        private static FFmpegPixelFormat GetFFmpegPixelFormat(RawFramesDecoding.PixelFormat pixelFormat)
        {
            if (pixelFormat == RawFramesDecoding.PixelFormat.Bgra32)
                return FFmpegPixelFormat.BGRA;
            if (pixelFormat == RawFramesDecoding.PixelFormat.Grayscale)
                return FFmpegPixelFormat.GRAY8;
            if (pixelFormat == RawFramesDecoding.PixelFormat.Bgr24)
